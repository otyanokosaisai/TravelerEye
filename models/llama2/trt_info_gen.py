...
def main(args):
    ...
    if args.streaming:
        ...
        if runtime_rank == 0:
            ...
            out_text = print_output(tokenizer,
                         output_ids,
                         input_lengths,
                         sequence_lengths,
                         output_csv=args.output_csv,
    ...
    return out_text
def llama_infer(input_text,genre):
    input_text=f"About photo : {input_text}. Explain about the place where the photo taken,  including {genre} in detail only in English. Do not include this input text."
    # f"You are a sightseeing adviser and customer is watching one scenary and says '{input_text}'. Do not refere about your job. Tell customer information regarding {genre} of the scenary.Only show your words."
    args=argparse.Namespace(max_output_len=1024, max_attention_window_size=None, sink_token_length=None, log_level='error', 
    engine_dir='/workspace/travel_photo_app/models/llama2/engine', use_py_session=False, 
    input_text=[input_text], 
    use_prompt_template=True, input_file=None, max_input_length=923, output_csv=None, output_npy=None, output_logits_npy=None, 
    tokenizer_dir='/workspace/travel_photo_app/models/llama2/Llama-2-7b-chat-hf', tokenizer_type=None, vocab_file=None, num_beams=1, temperature=1.0, top_k=1, top_p=0.0, 
    length_penalty=1.0, repetition_penalty=1.0, presence_penalty=0.0, frequency_penalty=0.0, debug_mode=False, add_special_tokens=True, streaming=False, 
    streaming_interval=5, prompt_table_path=None, prompt_tasks=None, lora_dir=None, lora_task_uids=None, lora_ckpt_source='hf', num_prepend_vtokens=None,
    run_profiling=False, medusa_choices=None)
    return main(args)